...
final class CategoryListViewController: UIViewController {
    private let contentView = CategoryListView()
    ...
    private func configureTableView() {
        ...
        contentView.tableView.register(
            CategoryListTableViewBasicCell.self,
            forCellReuseIdentifier: CategoryListTableViewBasicCell.reuseID
        )
        contentView.tableView.register(
    ...
    private func makeMenuButton() -> UIBarButtonItem {
        ...
        menuButton.menu = makeCategoryMenu()
        return menuButton
    }
...
extension CategoryListViewController {
    ...
    @objc private func didTapDoneButton() {
        ...
        viewModel.action(.didTapreorderCategoryButton)
...
extension CategoryListViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        switch editorMode {
        case .viewing:
            return makeCategoryCell(tableView: tableView, indexPath: indexPath, category: category)
        case .reordering:
            return makeReorderingCell(tableView: tableView, indexPath: indexPath, category: category)
        }
    }
...
extension CategoryListViewController: UITableViewDelegate {
    ...
    func tableView(
        ...
        viewModel.action(.deleteCategory(at: indexPath.row))
    }
}
